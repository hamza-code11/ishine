        ...
        <footer className="bg-[#0f172a] text-white pt-16 pb-8 border-t border-slate-800 font-sans">
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        <div className="flex gap-3">
                            {[
                                ...
                                <a
                                    key={social.name}
                                    href="#"
                                    className="size-10 bg-slate-800 hover:bg-primary rounded-xl flex items-center justify-center transition-all border border-slate-700 group text-slate-400 hover:text-white text-lg"
                                >
                                    {social.icon}
                                </a>
                            ))}
                    ...
                    {/* 2. Quick Links */}
                    <div>
                        <h4 className="text-[12px] font-black uppercase tracking-[0.2em] text-primary mb-8">Explore</h4>
                    ...
                    {/* 3. Categories */}
                    <div>
                        <h4 className="text-[12px] font-black uppercase tracking-[0.2em] text-primary mb-8">Categories</h4>
                        <ul className="space-y-4">
                            {categories.map((cat) => (
                                <li key={cat.name}>
                    ...
                    {/* 4. Contact Info */}
                    <div className="space-y-6">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.2em] text-primary mb-8">Contact Us</h4>
                        <ul className="space-y-5 text-sm">
                            ...
                            <li className="flex items-center gap-4 text-slate-400 group">
                                ...
                                <span className="font-bold group-hover:text-white transition-colors border-b border-transparent group-hover:border-primary">
                ...
                <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6 text-[10px] text-slate-500 font-black uppercase tracking-widest">
                        ...
                        <p className="text-primary/60">Wholesale Mobile Parts Expert</p>
                    </div>
