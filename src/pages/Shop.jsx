  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Shop Collection</h1>
          <p className="text-gray-500 text-sm mt-2">Explore our latest premium products</p>
        </div>
